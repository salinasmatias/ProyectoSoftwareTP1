...
namespace DataAccess.Migrations
{
    ...
    [Migration("20210916033218_CreatingCine")]
    partial class CreatingCine
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccess.Models.Funciones", b =>
                {
            ...
            modelBuilder.Entity("DataAccess.Models.Peliculas", b =>
                {
                    b.Property<int>("PeliculaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DataAccess.Models.Salas", b =>
                {
                    b.Property<int>("SalaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DataAccess.Models.Tickets", b =>
                {
            ...
            modelBuilder.Entity("DataAccess.Models.Funciones", b =>
                {
                    b.HasOne("DataAccess.Models.Peliculas", "Pelicula")
                        .WithMany("Funciones")
                        .HasForeignKey("PeliculaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DataAccess.Models.Salas", "Sala")
                        .WithMany("Funciones")
            ...
            modelBuilder.Entity("DataAccess.Models.Tickets", b =>
                {
                    b.HasOne("DataAccess.Models.Funciones", "Funcion")
                        .WithMany("Tickets")
